...
InfoBox::InfoBox(std::string title, std::string message, bool modal)
    : DialogBase(title, 
                 Utilities::CountLines(message, getmaxx(stdscr)-2), 
                 Utilities::CountStrWidth(message), 
                 getmaxy(stdscr)/2 - Utilities::CountLines(message, getmaxx(stdscr)-2)/2, 
...
ConfirmBox::ConfirmBox(std::string title, std::string message, bool modal)
    : DialogBase(title, 
                 Utilities::CountLines(message+cnf, getmaxx(stdscr)-2), 
                 Utilities::CountStrWidth(message+cnf), 
                 getmaxy(stdscr)/2 - (Utilities::CountLines(message+cnf, getmaxx(stdscr)-2))/2, 
